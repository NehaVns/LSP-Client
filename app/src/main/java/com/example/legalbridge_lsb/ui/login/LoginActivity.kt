package com.example.legalbridge_lsb.ui.login
...
import com.example.legalbridge_lsb.databinding.ActivityLoginBinding
import com.example.legalbridge_lsb.ui.ForgetPassword.ForgetPassword
import com.example.legalbridge_lsb.ui.MainActivity
import com.example.legalbridge_lsb.ui.helper.SharedPreference
import com.example.legalbridge_lsb.ui.helper.SpinnerConstants
import com.example.legalbridge_lsb.ui.helper.utils
...
//          val p = "$2b$10$b/vuS/QnS4xeNWpESfJyAeb6.e.m7S4ELAOmVeQPjGNUc/Lh382sO"
            ...
            val LoginUserResquest = LoginLSPResquest(
                email= binding?.emailEditText?.text.toString(),
                password = password
            )

            val apiService = RetrofitClient.getApiService()
            val call = apiService.loginLSP(LoginUserResquest)
